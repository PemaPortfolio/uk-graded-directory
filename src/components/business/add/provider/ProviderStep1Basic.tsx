...
/**
 * Provider Form Step 1: Basic Information (Spec 03)
 *
 * Business name and address details - same structure as store.
 */

import type { ProviderStep1Data } from '@/types/business'

interface ProviderStep1BasicProps {
  data: Partial<ProviderStep1Data>
  onChange: (data: Partial<ProviderStep1Data>) => void
  errors?: Record<string, string>
  className?: string
}

export function ProviderStep1Basic({
  data,
  onChange,
  errors = {},
  className = '',
}: ProviderStep1BasicProps) {
  const handleChange = (field: keyof ProviderStep1Data, value: string) => {
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div>
        ...
        <input
          ...
          placeholder="e.g., Quick Fix Appliance Repairs"
          className={`
            w-full h-12 px-4
            text-base
            border rounded-lg
...
export default ProviderStep1Basic
