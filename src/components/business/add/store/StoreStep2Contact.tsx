...
/**
 * Store Form Step 2: Contact Details (Spec 03)
 *
 * Phone, email, website, and social links.
 */

import type { StoreStep2Data } from '@/types/business'

interface StoreStep2ContactProps {
  data: Partial<StoreStep2Data>
  onChange: (data: Partial<StoreStep2Data>) => void
  errors?: Record<string, string>
  className?: string
}

export function StoreStep2Contact({
  data,
  onChange,
  errors = {},
  className = '',
}: StoreStep2ContactProps) {
  const handleChange = (field: keyof StoreStep2Data, value: string) => {
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div>
        ...
        <input
          ...
          placeholder="e.g., info@manchesterappliances.co.uk"
          className={`
            w-full h-12 px-4
            text-base
            border rounded-lg
      ...
      <div>
        ...
        <input
          ...
          placeholder="e.g., https://www.manchesterappliances.co.uk"
          className={`
            w-full h-12 px-4
            text-base
            border rounded-lg
      ...
      <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Optional - helps customers find and review your business
        </p>
      </div>
      ...
      <div>
        ...
        <input
          ...
          placeholder="e.g., https://facebook.com/manchesterappliances"
          className={`
            w-full h-12 px-4
            text-base
            border rounded-lg
...
export default StoreStep2Contact
